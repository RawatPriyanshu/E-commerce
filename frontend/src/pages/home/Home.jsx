...
const Home = () => {
      ...
      <section className="bestOfMen">
        ...
        <div className="bestOfMenList">
          {products.length === 0 ?(
            ...
            products.filter(product => product.category.toLowerCase() === "men").slice(0, 6).map((product)=>(
              <Link to={`/product/${product._id}`} className='product-link'>
              <div key={product._id} className="product-card">
            <div className='product-image'><img src={product.image} alt={product.name}/></div>
            <h3 className='product-title'>{product.name.length > 20 ? product.name.slice(0, 20) + "..." : product.name}</h3>
      ...
      <section className="bestOfWomen">
        ...
        <div className="bestOfWomenList">
          {products.length === 0 ?(
            ...
            products.filter(product => product.category.toLowerCase() === "women").slice(0, 6).map((product)=>(
              <Link to={`/product/${product._id}`} className='product-link'>
              <div key={product._id} className="product-card">
            <div className='product-image'><img src={product.image} alt={product.name}/></div>
            <h3 className='product-title'>{product.name.length > 20 ? product.name.slice(0, 20) + "..." : product.name}</h3>
      ...
      <section className="bestOfKids">
        ...
        <div className="bestOfKidsList">
          {products.length === 0 ?(
            ...
            products.filter(product => product.category.toLowerCase() === "kids").slice(0, 6).map((product)=>(
            <Link to={`/product/${product._id}`} className='product-link'>
              <div key={product._id} className="product-card">
            <div className='product-image'><img src={product.image} alt={product.name}/></div>
            <h3 className='product-title'>{product.name.length > 18 ? product.name.slice(0, 18) + "..." : product.name}</h3>
            <p className='product-description'>₹{product.price}</p>
          </div>
            </Link>
            ))
      ...
      <section className='bestOfHome'>
        ...
        <div className='bestOfHomeList'>
          {products.length === 0 ?(
            ...
            products.filter(product => product.category.toLowerCase() === "home").slice(0, 4).map((product)=>(
              <Link to={`/product/${product._id}`} className='product-link'>
              <div key={product._id} className="product-card">
            <div className='product-image'><img src={product.image} alt={product.name}/></div>
            <h3 className='product-title'>{product.name.length > 18 ? product.name.slice(0, 18) + "..." : product.name}</h3>
  ...
  <div className="footer-container">
    <div className="footer-section">
      <div className="footer-logo"><img src="/images/logo.png" alt="logo-mob" /></div>
    ...
    <div className="footer-section links-section">
      <h4>Follow Us</h4>
      <ul>
        <li><a href="#"><i className="facebook"></i> Facebook</a></li>
        <li><a href="#"><i className="twitter"></i> Twitter</a></li>
        <li><a href="#"><i className="instagram"></i> Instagram</a></li>
        <li><a href="#"><i className="linkedin"></i> LinkedIn</a></li>
      </ul>
    </div>
</div>
    {/* Contact Info */}
